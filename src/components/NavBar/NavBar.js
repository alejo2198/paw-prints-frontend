    ...
    return (
        <nav className="nav">
            <ul className="nav__list">
                <li className="nav__item"><Link to='/profile/1' className="nav__link"><img className="nav__icon" src={DogLink} alt=""  /></Link></li>
                <li className="nav__item"><Link to='/pawpost/add' className="nav__link"><img className="nav__icon" src={PawPostLink} alt=""  /></Link></li>
                <li className="nav__item"><Link to='/bond/1' className="nav__link"><img className="nav__icon" src={BondLink} alt=""  /></Link></li>
            </ul>
        </nav>
    );
};
